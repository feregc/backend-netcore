...
namespace SistemaVenta.BLL.Services
{
    public class VentaService : IVentaService
    {
        ...
        public async Task<VentaDTO> Registrar(VentaDTO modelo)
        {
            try
            {
                var ventaGenerada = await _ventaRepository.ToRegister(_mapper.Map<Venta>(modelo));
        ...
        {
            IQueryable<Venta> query = await _ventaRepository.Query();
            ...
            try
            {
                if (buscarPor == "fecha")
                {
                    ...
                    ListaResultado = await query.Where(v =>
                        ...
                        v.FechaRegistro.Value <= fech_Fin.Date).Include(dv => dv.DetalleVenta)
        ...
        {
            IQueryable<DetalleVenta> query = await _detalleVentaRepositorio.Query();
